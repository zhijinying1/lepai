...
public class ZXDataInfo {
    ...
    public ZXDataInfo(String title, String pic_url, String web_url) {
        this.title = title;
    ...
    public ZXDataInfo(String title, String pic_url) {

        this.title = title;
        this.pic_url = pic_url;
    }

    public ZXDataInfo(String title, String pic_url, String doc_url, String web_url, String more_comment_url) {
        this.title = title;
        this.pic_url = pic_url;
